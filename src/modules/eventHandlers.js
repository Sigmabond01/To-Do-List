...
export function showProjectForm(model, projectName) {
    if (!projectContainer || !createProjectForm) {
      console.error("projectContainer or createProjectForm is null");
      return;
    }
...
newProject.addEventListener("click", () => showProjectForm("create"));
